...
public class SibServiceServiceLocator extends org.apache.axis.client.Service implements com.avosh.baseproject.backchannel.soap.cartInquiry.SibServiceService {
    ...
    private java.lang.String SibServiceSoap11_address = "https://cb.tejaratbank.ir:443/service/destinationCardVerificationService/";
    ...
    public com.avosh.baseproject.backchannel.soap.cartInquiry.SibService getSibServiceSoap11() throws javax.xml.rpc.ServiceException {
    ...
    public com.avosh.baseproject.backchannel.soap.cartInquiry.SibService getSibServiceSoap11(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.avosh.baseproject.backchannel.soap.cartInquiry.SibServiceSoap11Stub _stub = new com.avosh.baseproject.backchannel.soap.cartInquiry.SibServiceSoap11Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.avosh.baseproject.backchannel.soap.cartInquiry.SibService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.avosh.baseproject.backchannel.soap.cartInquiry.SibServiceSoap11Stub _stub = new com.avosh.baseproject.backchannel.soap.cartInquiry.SibServiceSoap11Stub(new java.net.URL(SibServiceSoap11_address), this);
                _stub.setPortName(getSibServiceSoap11WSDDServiceName());
                return _stub;
            }
