...
public class SibServiceServiceLocator extends org.apache.axis.client.Service implements com.avosh.baseproject.backchannel.soap.cartTransfer.SibServiceService {
    ...
    private java.lang.String SibServiceSoap11_address = "https://cb.tejaratbank.ir:443/service/cardTransferService/";
    ...
    public com.avosh.baseproject.backchannel.soap.cartTransfer.SibService getSibServiceSoap11(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.avosh.baseproject.backchannel.soap.cartTransfer.SibService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.avosh.baseproject.backchannel.soap.cartTransfer.SibServiceSoap11Stub _stub = new com.avosh.baseproject.backchannel.soap.cartTransfer.SibServiceSoap11Stub(new java.net.URL(SibServiceSoap11_address), this);
                _stub.setPortName(getSibServiceSoap11WSDDServiceName());
                return _stub;
            }
        }
